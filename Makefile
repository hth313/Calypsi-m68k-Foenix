...
C_SRCS = mcp_errors.c mcp_syscalls.c $(STUB_SRCS)
STUB_SRCS = stub_assert.c stub_exit.c stub_open.c stub_write.c stub_close.c stub_lseek.c stub_read.c stub_rename.c stub_remove.c stub_environ.c
